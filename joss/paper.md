...
# Summary
Reflectance spectroscopy is one of the most powerful remote sensing tools in planetary science. By measuring how sunlight reflects off an airless planetary surface across different wavelengths, scientists can identify surface compositions, constrain physical properties such as grain size and porosity, and investigate processes like radiation weathering. However, the extraction of quantitative information from reflectance spectra is complicated by the presence of strong degeneracies between these parameters (see [@fig:reflectance_schematic]).

![A schematic diagram showing the key parameters affecting reflectance from a planetary surface.](figures/reflectance_schematic.jpeg){#fig:reflectance_schematic width=75%}
